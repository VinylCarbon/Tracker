...
import static com.tracker.common.utils.DistanceFormatter.DistanceUnits.MILES;
...
public final class DistanceFormatter {
     ...
     * @return distance string formatted according to the rules of hte formatter.
     */
    public static String format(int distanceInMeters, DistanceUnits units) {
        return format(distanceInMeters, false, units);
    }
    ...
    public static String format(int distanceInMeters, boolean realTime, Locale locale) {
        if (useMiles(locale)) {
            return format(distanceInMeters, realTime, locale, MILES);
        } else {
            return format(distanceInMeters, realTime, locale, KILOMETERS);
        }
    }
